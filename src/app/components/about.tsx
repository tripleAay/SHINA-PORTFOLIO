  ...
  return (
    ...
    >
      ...
      {/* =====================================================
          ...
          On mobile the pink background is already visually
          expressive, so the yellow glow is reduced heavily.
      ====================================================== */}

      <div
        className={`pointer-events-none absolute left-1/2 top-[30%] h-[520px] w-[520px] -translate-x-1/2 rounded-full blur-3xl ${
          lightMode
      ...
      {/* =====================================================
          SUBTLE MOBILE ATMOSPHERE

          Adds depth to the pink canvas without introducing
          another competing visual element.
      ====================================================== */}
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24 sm:px-8 md:py-32 lg:px-10 lg:py-36">
        ...
        >
          <div
            className={`border-t pt-10 ${
              lightMode
                ? 'border-black/[0.08] sm:border-black/[0.07]'
                : 'border-white/[0.07]'
            }`}
          >
            <div className="grid gap-10 lg:grid-cols-[0.62fr_1.38fr] lg:gap-20">
              ...
              <div>
                ...
                <p
                  className={`mt-5 max-w-[220px] text-xs leading-6 ${
                    lightMode
                      ? 'text-gray-500 sm:text-gray-400'
                      : 'text-gray-600'
                  }`}
                ...
                <div
                  className={`mt-7 hidden h-px w-10 lg:block ${
                    lightMode
                      ? 'bg-black/10'
                      : 'bg-white/10'
                  }`}
              ...
              >
                ...
                <p className="mt-6">
                  ...
                  code — it is to{' '}
                  <span className="font-medium text-yellow-500 sm:text-yellow-400">
        ...
        >
          <div
            className={`relative border-l-2 pl-6 sm:pl-8 ${
              lightMode
                ? 'border-yellow-500/70 sm:border-yellow-400/80'
          ...
          >
            ...
            <p
              className={`mt-5 max-w-3xl text-2xl font-medium leading-[1.3] tracking-[-0.03em] sm:text-3xl ${
                lightMode
                  ? 'text-gray-900'
                  : 'text-gray-200'
              }`}
        ...
        <div className="mx-auto mt-24 max-w-4xl">
          ...
          <div
            className={`mb-8 flex items-center justify-between border-t pt-6 ${
              lightMode
                ? 'border-black/[0.08]'
                : 'border-white/[0.07]'
            }`}
          ...
          <div className="grid sm:grid-cols-3">
            {highlights.map((item, index) => (
              <motion.div
                ...
                className={`group relative py-6 sm:px-6 sm:py-7 ${
                  index !== 0
                    ? lightMode
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="h-1.5 w-1.5 rounded-full bg-yellow-500 sm:bg-yellow-400 transition-transform duration-300 group-hover:scale-[1.7]" />
                </div>

                {/* Title */}

                <h3
                  className={`mt-5 text-lg font-semibold tracking-tight transition-all duration-300 group-hover:translate-x-1 ${
                    lightMode
                      ? 'text-gray-950'
                      : 'text-white'
                  }`}
                ...
                <span
                  className={`absolute bottom-0 left-6 h-px w-0 bg-yellow-500 sm:bg-yellow-400 transition-all duration-300 group-hover:w-10 ${
                    index === 0
                      ? 'sm:left-0'
                      : ''
                  }`}
        ...
        >
          <div
            className={`flex flex-col gap-6 border-t pt-7 sm:flex-row sm:items-center sm:justify-between ${
              lightMode
                ? 'border-black/[0.08]'
                : 'border-white/[0.07]'
            }`}
          >
            ...
            >
              ...
              <span
                className={`flex h-8 w-8 items-center justify-center rounded-full transition-all duration-300 group-hover:translate-x-1 group-hover:bg-yellow-400 group-hover:text-gray-950 ${
                  lightMode
